...
class BeerAdapter(private val beerList: List<Beer>, private val onClickListener:(Beer) -> Unit, private val addToFavoriteListener:(Beer) -> Unit) : RecyclerView.Adapter<BeerViewHolder>() {
